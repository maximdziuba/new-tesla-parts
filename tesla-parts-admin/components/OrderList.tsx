                ...
                return (
                  ...
                  >
                    <td className="px-6 py-5">
                      ...
                      <div className="text-[10px] font-bold text-gray-400 mt-0.5 uppercase">
                    ...
                    <td className="px-6 py-5">
                      <span
                        className={`px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-wider ${statusDisplay.className}`}
                      >
                        {statusDisplay.text}
                      </span>
                    </td>
                    <td className="px-6 py-5 text-sm text-gray-700">
                      {editingTtnOrderId === order.id ? (
                        ...
                        <div className="flex items-center justify-end gap-2">
                          <span className="font-mono text-xs font-bold text-slate-700 mr-auto">
                            {order.ttn || "---"}
                          </span>
                          <button
                            onClick={(e) => {
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="p-8 overflow-y-auto space-y-8">
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 mb-3">
                    Клієнт
                  </h3>
                  <div className="space-y-1">
              ...
              <div>
                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 mb-4">
                  Товари
                </h3>
                          ...
                          <td className="px-4 py-4">
                            <div className="flex items-center gap-4">
                              {item.product_image ? (
                                ...
                                <div className="w-16 h-16 bg-gray-100 rounded-lg border border-gray-200 shadow-sm flex items-center justify-center text-gray-400 text-xs">
                                  Немає фото
                                </div>
                              )}
                              <div>
                                {item.product_name ? (
                                  <a
                                    href={`https://teslafix.com.ua/product/${item.product_id}`}
                                    target="_blank"
                                    rel="noreferrer"
                                    className="font-bold text-blue-600 hover:text-blue-800 hover:underline transition-colors block"
                                  >
                                    {item.product_name}
                                  </a>
                                ) : (
