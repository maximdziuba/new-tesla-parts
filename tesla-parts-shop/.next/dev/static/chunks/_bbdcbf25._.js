    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero.useEffect": ()=>{
            const fetchCategories = {
                "Hero.useEffect.fetchCategories": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getCategories();
                        setCategories(data);
                    } catch (e) {
                        console.error("Failed to fetch categories", e);
                    }
                }
            }["Hero.useEffect.fetchCategories"];
            fetchCategories();
        }
    }["Hero.useEffect"], []);
...
_s(Hero, "+ijgB8ROEl0Dkz53OTIi8GynN6s=");
_c = Hero;
...
function Home() {
    _s();
    const { currency, uahPerUsd, addToCart, staticSeo, loading: appLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AppContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApp"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const fetchPopular = {
                "Home.useEffect.fetchPopular": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getProducts({
                            limit: 8
                        });
                        setProducts(data);
                    } catch (e) {
...
_s(Home, "h476HpkLVyKSjX7mh6y0/Y4EGDo=", false, function() {
    return [
...
//# sourceMappingURL=_bbdcbf25._.js.map