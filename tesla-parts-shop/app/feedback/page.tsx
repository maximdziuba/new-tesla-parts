...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      ...
      description: seoRecord?.meta_description || 'Що говорять про нас наші клієнти. Скріншоти відгуків про запчастини та сервіс TeslaFix.',
    };
  } catch (e) {
    console.error('Failed to generate feedback page metadata:', e);
    return {
      title: 'Відгуки клієнтів | TeslaFix',
      description: 'Що говорять про нас наші клієнти. Скріншоти відгуків про запчастини та сервіс TeslaFix.',
    };
  }
}
