...
const StaticPageClient: React.FC<StaticPageClientProps> = ({ slug, initialPage, initialSeo, fallbackTitle }) => {
        ...
        <div className="py-12 max-w-2xl mx-auto transition-colors">
            ...
            {initialPage ? (
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: initialPage.content.replace(/\n/g, '<br />') }}
                />
            ) : (
