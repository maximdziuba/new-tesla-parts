...
const SubcategoryCard: React.FC<SubcategoryCardProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full aspect-[16/10] bg-gray-100 dark:bg-slate-900 flex-shrink-0 overflow-hidden mb-4 flex items-center justify-center rounded-lg">
        <img
          src={
            subcategory.image ||
            "https://www.tesla.com/ownersmanual/images/GUID-EE2A1356-1432-4B7F-86BB-7AB3569937C8-online-en-US.png"
          }
          alt={subcategory.name}
          className="w-full h-full object-cover xl:group-hover:scale-102 transition-transform duration-500"
        />
      </div>
