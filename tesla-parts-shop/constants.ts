...
export const DEFAULT_SETTINGS = {
  ...
  footer_description:
    "Ваш надійний партнер у світі запчастин для Tesla. Ми пропонуємо широкий асортимент оригінальних та якісних аналогів для всіх моделей Tesla.",
};
...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    priceUSD: 312.5,
    image:
      "https://a.allegroimg.com/original/11a051/3fa7a4874a2cba5bf5f6e69af13a/TESLA-MODEL-3-2017-17-NADKOLE-PRZEDNIE-PRZOD-LEWA-LEWE-LH",
    description:
