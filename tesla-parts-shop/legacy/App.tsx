...
const HomeView: React.FC<HomeViewProps> = ({
  ...
  const fallbackTitle = 'Auto Parts Store | Магазин запчастин для Tesla';
...
const SearchView: React.FC<SearchViewProps> = ({
  ...
  const fallbackTitle = `Пошук: ${normalizedQuery} | Auto Parts Store`;
...
const CategoryView: React.FC<CategoryViewProps> = ({
  ...
  const fallbackTitle = `${pageHeading} | Auto Parts Store`;
