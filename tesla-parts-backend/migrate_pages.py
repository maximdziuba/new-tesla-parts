...
def migrate():
    ...
    default_pages = [
        ...
        ("privacy-policy", "Політика конфіденційності", "Політика конфіденційності інтернет-магазину TeslaFix.", True, "footer"),
        ("terms-of-service", "Умови сервісу", "Умови сервісу інтернет-магазину TeslaFix.", True, "footer"),
    ]
